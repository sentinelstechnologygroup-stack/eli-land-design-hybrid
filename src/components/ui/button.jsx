  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-button text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // ✅ ELI-specific (matches Contact button style)
        eli: "bg-[#1F2E23] text-[#F5F0EA] hover:bg-[#2A3F2F] tracking-[0.25em] uppercase text-[11px] font-sans-clean font-semibold",
      },
      size: {
        default: "h-9 px-4 py-2",
        // ✅ remove per-size rounding to keep radius centralized
        sm: "h-8 px-3 text-xs",
        lg: "h-10 px-8",
        icon: "h-9 w-9",

        // ✅ ELI CTA sizing
        eli: "h-auto px-10 py-5",
      },
    },
    defaultVariants: {
      variant: "default",
