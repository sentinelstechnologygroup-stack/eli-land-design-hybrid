...
export const REVIEWS_RAW = [
  ...
  {
    quote:
      "ELI Land Design designed and installed the most amazing landscaping for our Spanish Revival home in Bentwater on Lake Conroe. From start-up of the project to the finish, we were extremely pleased with their high level of customer service, personal attention to details, knowledge of plants and subsequent designs along with quality workmanship. They are very flexible to meet the customer’s needs and make the applicable recommendations to ensure the plants are in the right locations and climate. Once the project is complete, they continue to stay in touch, answer questions and come by regularly to check on the landscaping and irrigation system. Since June we have had one rain shower, and surprisingly our plants are thriving. Working with Chris and his team was the best experience in our entire new home project. I would highly recommend utilizing ELI Land Design.",
    name: "Jane Traper",
    meta: "ELI Client",
  },
  {
  ...
  {
    quote:
      "Chris and crew did an outstanding job on the landscaping of our new home in the fall of 2013. It was October/November when they put it in and almost every plant made it through the winter. What did not, he promptly replaced without hesitation. Our back yard needed an extensive drainage system to work with our infinity pool and I can proudly say that the water has not once flowed into the pool from the yard! I would recommend ELI highly to all for all types of landscaping needs.",
    name: "Steve",
    meta: "ELI Client",
  },
  {
